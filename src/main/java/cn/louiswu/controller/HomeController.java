...
import cn.louiswu.dto.ArchiveDto;
import cn.louiswu.dto.cond.ContentCond;
import cn.louiswu.model.BeforeLogsDomain;
import cn.louiswu.model.CommentDomain;
import cn.louiswu.model.ContentDomain;
import cn.louiswu.service.about.AboutService;
import cn.louiswu.service.beforelogs.BeforeLogsService;
import cn.louiswu.service.meta.MetaService;
import cn.louiswu.utils.*;
import cn.louiswu.constant.ErrorConstant;
import cn.louiswu.constant.Types;
import cn.louiswu.constant.WebConst;
import cn.louiswu.exception.BusinessException;
import cn.louiswu.service.comment.CommentService;
import cn.louiswu.service.content.ContentService;
...
/**
 * 首页和关于我的页面控制器
 * Created by LouisWu on 2018/11/28.
 */
@Api("网站首页和关于页面")
@Controller
public class HomeController extends BaseController{
    ...
    @GetMapping(value = "/jianli/index")
    public String getJianli(HttpServletRequest request){
        return "site/luis/index";
    }
    ...
    public String getAbout(HttpServletRequest request){
        ...
        request.setAttribute("aboutInfo",aboutService.getAbout());
        return "site/about";
    }
...
//        String ip = "47.102.99.193";
        if (!"0:0:0:0:0:0:0:1".equals(ip)){
            String ipJson = IpAddress.getIpJson(ip);
            JSONObject jsonObject = new JSONObject(ipJson);
            if (jsonObject.get("error_code").equals(1000)){
                ...
                BeforeLogsDomain beforeLogsDomain = new BeforeLogsDomain();
                beforeLogsDomain.setAddress(address);
                beforeLogsDomain.setIp(ip);
                beforeLogsService.insertBefore(beforeLogsDomain);
            }
